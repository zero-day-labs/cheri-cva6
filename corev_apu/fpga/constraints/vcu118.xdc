...
## UART2
set_property -dict {PACKAGE_PIN AT15 IOSTANDARD LVCMOS18} [get_ports tx2]
set_property -dict {PACKAGE_PIN AT16 IOSTANDARD LVCMOS18} [get_ports rx2]
...
set_property -dict {PACKAGE_PIN AW15 IOSTANDARD  LVCMOS18} [get_ports spi_miso] ;PMOD0_2
